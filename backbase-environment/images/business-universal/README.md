...
docker pull --platform=linux/amd64 harbor.backbase.eu/development/business-universal:2023.02-LTS
```
...
docker build --platform=linux/amd64 --secret id=npm,src=$(pwd)/.npmrc -t harbor.backbase.eu/development/business-universal:2023.02-LTS .
```
...
docker build --platform=linux/amd64 --secret id=npm,src=$(echo $HOME)/.npmrc -t harbor.backbase.eu/development/business-universal:2023.02-LTS .
```
